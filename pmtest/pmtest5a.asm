...
LABEL_DESC_VIDEO:       Descriptor 0b8000h,  0ffffh,            DA_DRW+DA_DPL3          ; video segment (DPL=0)
...
LABEL_CALL_GATE_TEST: Gate SelectorCodeDest, 0,     0,      DA_386CGate+DA_DPL0     ; call gate segment (DPL=0)
; End of GDT
